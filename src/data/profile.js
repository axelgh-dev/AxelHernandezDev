...
export const content = {
  es: {
    ...
    skills: {
      ...
      "Profesional": ["Resolución de Problemas", "Pensamiento Analítico", "Trabajo en Equipo", "Aprendizaje Continuo", "Agile / Scrum"],
    },
    certifications: [
    ...
    sectionsTitle: { experience: "Experiencia Profesional", education: "Educación", skills: "Competencias Técnicas", certifications: "Certificaciones", learning: "En Aprendizaje" },
  ...
  en: {
    ...
    skills: {
      ...
      "Cloud & DevOps": ["Ubuntu Server", "NGINX", "PM2", "Git", "DigitalOcean", "AWS", "Azure"],
      "Professional": ["Problem Solving", "Analytical Thinking", "Team Collaboration", "Continuous Learning", "Agile / Scrum"],
    },
    certifications: [
    ...
    sectionsTitle: { experience: "Professional Experience", education: "Education", skills: "Core Competencies", certifications: "Certifications", learning: "Currently Learning" },
