...
export const content = {
  es: {
    ...
    learning: ["JavaScript avanzado", "Web Performance", "Progressive Web Apps", "IA Generativa / LLMs", "AWS Skill Builder", "Google Cloud Skills Boost", "OpenAI Academy"],
    sectionsTitle: { experience: "Experiencia Profesional", education: "Educación", skills: "Habilidades Técnicas", certifications: "Certificaciones", learning: "En Aprendizaje" },
  ...
  en: {
    ...
    learning: ["Advanced JavaScript", "Web Performance", "Progressive Web Apps", "Generative AI / LLMs", "AWS Skill Builder", "Google Cloud Skills Boost", "OpenAI Academy"],
    sectionsTitle: { experience: "Professional Experience", education: "Education", skills: "Technical Skills", certifications: "Certifications", learning: "Currently Learning" },
